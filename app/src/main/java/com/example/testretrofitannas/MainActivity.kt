package com.example.testretrofitannas
...
import com.example.testretrofitannas.adapter.MovieAdapter
...
import com.example.testretrofitannas.service.ApiClient
import com.example.testretrofitannas.service.ApiInterface
...
//        }
        ...
        call.enqueue(object : Callback<Movie> {
            ...
            override fun onResponse(call: Call<Movie>?, response: Response<Movie>?) {
                if (response != null) {
                    ...
                    var toastposter : String? = originalTitle
                    if (posterPath == null) {
                        collapseImage.setImageResource(R.drawable.ic_launcher_background)
                        ToasPosterBesar(toastposter.toString())
                    } else {
    ...
    fun ToasPosterBesar(judul : String){
        collapseImage.setOnClickListener {
            Toast.makeText(applicationContext, "${judul}", Toast.LENGTH_SHORT).show()
        }
    }
}
